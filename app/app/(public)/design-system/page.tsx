        ...
        {tabs.map(tab => (
          <button key={tab} onClick={() => setActive(tab)}
            style={{ padding: "8px 16px", borderRadius: 9999, fontSize: 13, fontWeight: 600, cursor: "pointer", border: "none",
              background: active === tab ? "#6366F1" : "#F3F4F6",
...
const colors = [
  ...
  { name: "Brand 500 (Primary)", hex: "#6366F1", token: "--brand-500 / --fp-primary", textWhite: true },
  { name: "Brand 600 (Hover)", hex: "#4F46E5", token: "--brand-600 / --fp-primary-hover", textWhite: true },
  { name: "Brand 700 (Dark)", hex: "#4338CA", token: "--brand-700 / --fp-primary-dark", textWhite: true },
  { name: "Brand 50 (Subtle)", hex: "#EEF2FF", token: "--brand-50 / --fp-primary-subtle", textWhite: false },
  { name: "Brand 100 (Light)", hex: "#E0E7FF", token: "--brand-100 / --fp-primary-light", textWhite: false },
  { name: "Brand 200 (Border)", hex: "#C7D2FE", token: "--brand-200 / --fp-primary-border", textWhite: false },
  /* ── Accent Pair ── */
  { name: "Violet 600", hex: "#7C3AED", token: "--fp-violet", textWhite: true },
  { name: "Violet 50 (Subtle)", hex: "#EDE9FE", token: "--fp-violet-subtle", textWhite: false },
  /* ── Gray System ── */
    ...
    <div style={{ fontFamily: "'Pretendard Variable', 'Pretendard', sans-serif", minHeight: "100vh", background: "#F7F8FA" }}>
      <style>{`
        ...
        * { font-family: 'Pretendard Variable', 'Pretendard', sans-serif; box-sizing: border-box; }
        ...
        .ds-nav-item:hover { background: #EEF2FF; color: #6366F1; }
        .ds-nav-item.active { background: #6366F1; color: #fff; }
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 2, background: "#F3F4F6", borderRadius: 8, padding: 3 }}>
              ...
              <Link href="/design-library" style={{ padding: "4px 12px", borderRadius: 6, fontSize: 13, fontWeight: 500, color: "#6B7280", textDecoration: "none", display: "flex", alignItems: "center", gap: 6, transition: "all 0.15s" }}>
                <BookOpen size={13} />
                디자인 라이브러리
                <span style={{ fontSize: 10, fontWeight: 700, background: "#EEF2FF", color: "#6366F1", padding: "1px 6px", borderRadius: 9999, border: "1px solid #C7D2FE" }}>NEW</span>
              </Link>
            </div>
          </div>
            ...
            <div>
              <div className="ds-section">
                ...
                <div style={{ display: "flex", gap: 12, flexWrap: "wrap" }}>
                  {[
                    { name: "Primary CTA", g: "linear-gradient(135deg,#6366F1,#8B5CF6)", token: "--brand-gradient" },
                    { name: "CTA Banner", g: "linear-gradient(135deg,#4F46E5,#7C3AED)", token: "--brand-gradient-dark" },
                ...
                <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
                  {spacing.map(s => (
                    <div key={s} style={{ display: "flex", alignItems: "center", gap: 16 }}>
                      ...
                      <div style={{ height: 8, width: s * 1.5, background: "linear-gradient(90deg,#6366F1,#8B5CF6)", borderRadius: 4 }} />
                      <code>space-{s / 4}</code>
                    </div>
                  ))}
                </div>
          ...
          {active === "Buttons" && (
            <div>
              ...
              <div style={{ background: "#fff", borderRadius: 12, border: "1px solid #F3F4F6", padding: 24, display: "flex", flexWrap: "wrap", gap: 12, alignItems: "center" }}>
                <button style={{ height: 44, padding: "0 20px", borderRadius: 10, border: "none", background: "linear-gradient(135deg,#2563EB,#4F46E5)", color: "#fff", fontSize: 15, fontWeight: 600, cursor: "pointer", boxShadow: "0 4px 14px rgba(37,99,235,0.35)" }}>Primary Gradient</button>
                ...
                <button style={{ height: 44, padding: "0 20px", borderRadius: 10, border: "none", background: "linear-gradient(135deg,#2563EB,#4F46E5)", color: "#fff", fontSize: 15, fontWeight: 600, cursor: "pointer", opacity: 0.5 }} disabled>Disabled</button>
              </div>
              ...
              <div style={{ background: "#fff", borderRadius: 12, border: "1px solid #F3F4F6", padding: 24, display: "flex", flexWrap: "wrap", gap: 12, alignItems: "center" }}>
                ...
                <button style={{ height: 52, padding: "0 32px", borderRadius: 10, border: "none", background: "linear-gradient(135deg,#2563EB,#4F46E5)", color: "#fff", fontSize: 16, fontWeight: 600, cursor: "pointer", boxShadow: "0 4px 14px rgba(37,99,235,0.35)" }}>Large (52px)</button>
              </div>

              <div className="ds-subsection">With Icon</div>
              <div style={{ background: "#fff", borderRadius: 12, border: "1px solid #F3F4F6", padding: 24, display: "flex", flexWrap: "wrap", gap: 12, alignItems: "center" }}>
                <button style={{ height: 44, padding: "0 20px", borderRadius: 10, border: "none", background: "linear-gradient(135deg,#2563EB,#4F46E5)", color: "#fff", fontSize: 15, fontWeight: 600, cursor: "pointer", display: "flex", alignItems: "center", gap: 8, boxShadow: "0 4px 14px rgba(37,99,235,0.35)" }}><Sparkles size={16} />카드뉴스 생성</button>
                ...
                <button style={{ height: 44, padding: "0 20px", borderRadius: 10, border: "none", background: "linear-gradient(135deg,#2563EB,#4F46E5)", color: "#fff", fontSize: 15, fontWeight: 600, cursor: "pointer", display: "flex", alignItems: "center", gap: 8 }}>1분 만에 시작하기 <ArrowRight size={16} /></button>
              ...
              <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(180px, 1fr))", gap: 16 }}>
                {[{ v: "90%", l: "콘텐츠 제작 시간 절감" }, { v: "5분", l: "카드뉴스 평균 제작" }, { v: "6+", l: "연동 SNS 채널" }, { v: "95%", l: "브랜드 스타일 일치도" }].map(s => (
                  <div key={s.l} style={{ background: "linear-gradient(135deg,#F8FAFF,#F0F4FF)", border: "1px solid #DBEAFE", borderRadius: 16, padding: 24, textAlign: "center" }}>
                    <div style={{ fontSize: 36, fontWeight: 800, background: "linear-gradient(135deg,#2563EB,#4F46E5)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent", marginBottom: 4 }}>{s.v}</div>
              ...
              <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(300px, 1fr))", gap: 16 }}>
                <div style={{ background: "#fff", border: "1px solid #F3F4F6", borderRadius: 16, padding: 24, boxShadow: "0 2px 12px rgba(0,0,0,0.04)" }}>
                  <div style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 16 }}>
                    <div style={{ width: 44, height: 44, borderRadius: "50%", background: "linear-gradient(135deg,#2563EB,#4F46E5)", display: "flex", alignItems: "center", justifyContent: "center", color: "#fff", fontWeight: 700 }}>김</div>
                    <div>
          ...
          {active === "Feedback" && (
            <div>
              ...
              <div style={{ background: "#fff", border: "1px solid #E5E7EB", borderRadius: 16, padding: 24 }}>
                <div style={{ display: "flex", flexDirection: "column", gap: 10, maxWidth: 360 }}>
                  {[
                    ...
                    { icon: <Info size={18} color="#6366F1" />, title: "AI 생성 중", msg: "카드뉴스를 생성하고 있어요...", border: "#C7D2FE", bg: "#EEF2FF" },
                  ].map(t => (
              ...
              <div style={{ background: "linear-gradient(135deg,#F8F7FF,#EEF2FF)", border: "1px solid #C7D2FE", borderRadius: 16, padding: 64, textAlign: "center" }}>
                <div style={{ fontSize: 80, fontWeight: 900, background: "linear-gradient(135deg,#6366F1,#8B5CF6)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent", lineHeight: 1, marginBottom: 16 }}>404</div>
                ...
                <div style={{ display: "flex", gap: 12, justifyContent: "center" }}>
                  <button style={{ padding: "12px 28px", borderRadius: 10, background: "linear-gradient(135deg,#6366F1,#8B5CF6)", color: "#fff", border: "none", fontSize: 15, fontWeight: 700, cursor: "pointer" }}>홈으로 이동</button>
            ...
            <div>
              ...
              <div style={{ background: "#fff", borderRadius: 12, border: "1px solid #F3F4F6", padding: 32, display: "flex", justifyContent: "center", gap: 48, alignItems: "flex-start" }}>
                {[
                  ...
                  { n: "02", t: "AI 생성", c: "#4F46E5", sh: "rgba(79,70,229,0.3)" },
              ...
              <div style={{ borderRadius: 20, padding: 40, background: "linear-gradient(135deg,#1D4ED8,#4F46E5)", textAlign: "center", position: "relative", overflow: "hidden" }}>
            ...
            <div>
              ...
              <div style={{ background: "#fff", borderRadius: 12, border: "1px solid #F3F4F6", padding: 24, display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(100px,1fr))", gap: 8 }}>
                {[
                  ...
                  { ic: <Shield size={20} />, n: "Shield", c: "#4F46E5" },
            ...
            <div>
              ...
              <div style={{ background: "#fff", borderRadius: 12, border: "1px solid #F3F4F6", overflow: "hidden" }}>
                <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", padding: "0 20px", height: 56, borderBottom: "1px solid #F3F4F6" }}>
                  <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
                    <div style={{ width: 28, height: 28, borderRadius: 8, background: "linear-gradient(135deg,#2563EB,#4F46E5)", display: "flex", alignItems: "center", justifyContent: "center" }}><Zap size={14} color="#fff" /></div>
                  ...
                  <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
                    ...
                    <div style={{ width: 36, height: 36, borderRadius: "50%", background: "linear-gradient(135deg,#6366F1,#8B5CF6)", display: "flex", alignItems: "center", justifyContent: "center" }}><User size={16} color="#fff" /></div>
                  </div>
                </div>
              </div>
              ...
              <div style={{ background: "#fff", border: "1px solid #E5E7EB", borderRadius: 16, overflow: "hidden", marginBottom: 24 }}>
                <div style={{ padding: "12px 24px", background: "#F8F7FF", borderBottom: "1px solid #EEF2FF", display: "flex", gap: 32, alignItems: "center" }}>
                  {["소개", "서비스", "ESG", "미디어", "투자정보"].map((m, i) => (
                    <div key={m} style={{ fontSize: 14, fontWeight: i === 0 ? 700 : 500, color: i === 0 ? "#6366F1" : "#374151", cursor: "pointer", borderBottom: i === 0 ? "2px solid #6366F1" : "none", paddingBottom: 4 }}>{m}</div>
                  ))}
                </div>
                ...
                <div style={{ width: 260, background: "#fff", borderRadius: "12px 0 0 12px", boxShadow: "4px 0 20px rgba(0,0,0,0.08)" }}>
                  ...
                  {["홈", "기능", "요금제", "문의하기"].map((m, i) => (
                    <div key={m} style={{ padding: "14px 20px", borderBottom: "1px solid #F9FAFB", display: "flex", justifyContent: "space-between", alignItems: "center", cursor: "pointer",
                      background: i === 1 ? "#EEF2FF" : "#fff", color: i === 1 ? "#6366F1" : "#374151", fontWeight: i === 1 ? 600 : 400, fontSize: 15 }}>
                      {m} <ChevronRight size={16} />
                    </div>
                  ))}
                  <div style={{ padding: 16 }}>
                    <button style={{ width: "100%", height: 44, borderRadius: 10, background: "linear-gradient(135deg,#6366F1,#8B5CF6)", color: "#fff", border: "none", fontWeight: 700, fontSize: 15, cursor: "pointer" }}>무료로 시작하기</button>
                  </div>
                </div>
            ...
            <div>
              ...
              <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(260px, 1fr))", gap: 16 }}>
                {[
                  ...
                  <div key={plan.name} style={{ background: plan.highlight ? "linear-gradient(135deg,#6366F1,#8B5CF6)" : "#fff", border: plan.highlight ? "none" : "1px solid #E5E7EB", borderRadius: 20, padding: 28, position: "relative" }}>
                    ...
                    <button style={{ width: "100%", height: 44, borderRadius: 10, border: plan.highlight ? "none" : "1.5px solid #E5E7EB", background: plan.highlight ? "#fff" : "transparent", color: plan.highlight ? "#6366F1" : "#374151", fontSize: 14, fontWeight: 600, cursor: "pointer" }}>{plan.cta}</button>
                  </div>
                ))}
              </div>
            </div>
              ...
              <div className="ds-section">
                ...
                <div style={{ background: "#fff", border: "1px solid #E5E7EB", borderRadius: 16, padding: 32, marginBottom: 24 }}>
                  <div style={{ display: "grid", gridTemplateColumns: "repeat(3,1fr)", gap: 0, borderRadius: 12, overflow: "hidden", border: "1px solid #E5E7EB" }}>
                    {[
                      { icon: <FileText size={24} color="#6366F1" />, num: "2,400+", label: "생성된 콘텐츠", sub: "이번 달" },
                      { icon: <Clock size={24} color="#6366F1" />, num: "68%", label: "시간 절약", sub: "평균 대비" },
                      { icon: <TrendingUp size={24} color="#6366F1" />, num: "4.9/5", label: "사용자 만족도", sub: "리뷰 1,200개" },
                    ].map((s, i) => (
                  ...
                  <p style={{ marginTop: 12, fontSize: 12, color: "#9CA3AF", textAlign: "center" }}>토큰: <code>--fp-primary</code> 아이콘 색상, <code>--fp-heading</code> 숫자, 3열 border 구분</p>
                </div>
                  ...
                  <div style={{ flex: 1, background: "linear-gradient(135deg,#EEF2FF,#F5F3FF)", display: "flex", alignItems: "center", justifyContent: "center", padding: 40 }}>
                    <div style={{ width: "100%", maxWidth: 280, background: "#fff", borderRadius: 16, padding: 20, boxShadow: "0 20px 40px rgba(99,102,241,0.12)" }}>
                      <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 16 }}>
                        ...
                        <div>
                          <div style={{ fontSize: 11, fontWeight: 700, color: "#6366F1" }}>AI 콘텐츠 생성</div>
                          <div style={{ fontSize: 13, fontWeight: 600, color: "#111827" }}>카드뉴스 초안</div>
                        </div>
                      </div>
                      {[90, 75, 60].map((w, i) => (
                        <div key={i} style={{ height: 8, borderRadius: 4, background: i === 0 ? "#6366F1" : "#E5E7EB", width: `${w}%`, marginBottom: 8 }} />
                      ))}
                      <div style={{ marginTop: 12, padding: "8px 12px", background: "#EEF2FF", borderRadius: 8, fontSize: 12, color: "#6366F1", fontWeight: 600, textAlign: "center" }}>✓ 생성 완료</div>
                    </div>
                  </div>
                  <div style={{ flex: 1, padding: "40px 48px", display: "flex", flexDirection: "column", justifyContent: "center" }}>
                    <span style={{ display: "inline-flex", padding: "4px 10px", background: "#EEF2FF", borderRadius: 9999, fontSize: 12, fontWeight: 700, color: "#6366F1", marginBottom: 16, width: "fit-content" }}>AI 생성</span>
                    ...
                    <button style={{ width: "fit-content", padding: "12px 24px", borderRadius: 10, background: "#6366F1", color: "#fff", border: "none", fontSize: 15, fontWeight: 600, cursor: "pointer", display: "flex", alignItems: "center", gap: 8 }}>
                ...
                <div style={{ borderRadius: 20, background: "linear-gradient(135deg,#6366F1,#8B5CF6)", padding: "48px 64px", display: "flex", alignItems: "center", justifyContent: "space-between", flexWrap: "wrap", gap: 24 }}>
                  <div>
                  ...
                  <div style={{ display: "flex", gap: 12 }}>
                    <button style={{ padding: "14px 28px", borderRadius: 10, background: "#fff", color: "#6366F1", border: "none", fontSize: 15, fontWeight: 700, cursor: "pointer" }}>무료로 시작하기</button>
                ...
                <div style={{ position: "relative", background: "#F3F4F6", borderRadius: 16, padding: 24, overflow: "hidden", minHeight: 120 }}>
                  ...
                  <div style={{ background: "#fff", borderRadius: 12, padding: "14px 20px", display: "flex", alignItems: "center", justifyContent: "space-between", boxShadow: "0 -4px 20px rgba(0,0,0,0.1)", border: "1px solid #F3F4F6" }}>
                    ...
                    <button style={{ padding: "10px 20px", borderRadius: 10, background: "linear-gradient(135deg,#6366F1,#8B5CF6)", color: "#fff", border: "none", fontSize: 14, fontWeight: 700, cursor: "pointer" }}>시작하기</button>
                  </div>
                </div>
              ...
              <div className="ds-section">
                ...
                <div style={{ background: "#fff", border: "1px solid #E5E7EB", borderRadius: 16, overflow: "hidden", marginBottom: 32 }}>
                  <div style={{ display: "grid", gridTemplateColumns: "2fr 1fr 1fr", background: "#F8F7FF" }}>
                    ...
                    <div style={{ padding: "16px 24px", fontSize: 13, fontWeight: 700, color: "#6366F1", textAlign: "center" }}>FlowPack</div>
                ...
                <div style={{ background: "linear-gradient(135deg,#F5F3FF,#EEF2FF)", borderRadius: 16, padding: 40, textAlign: "center", border: "1px solid #C7D2FE" }}>
                  <p style={{ fontSize: 13, fontWeight: 700, color: "#6366F1", textTransform: "uppercase", letterSpacing: "0.1em", marginBottom: 8 }}>얼리 액세스</p>
                  ...
                  <div style={{ display: "flex", gap: 8, maxWidth: 480, margin: "0 auto" }}>
                    ...
                    <button style={{ height: 48, padding: "0 24px", borderRadius: 10, background: "#6366F1", color: "#fff", border: "none", fontSize: 14, fontWeight: 600, cursor: "pointer", whiteSpace: "nowrap" }}>신청하기</button>
                  </div>
            ...
            <div>
              <div className="ds-section">
                ...
                <div style={{ background: "#fff", border: "1px solid #E5E7EB", borderRadius: 16, padding: 24, marginBottom: 24 }}>
                  {[
                    { label: "카드뉴스 생성", value: 80, color: "#6366F1" },
                    { label: "블로그 포스팅", value: 55, color: "#8B5CF6" },
                  ...
                  {[
                    ...
                    <div key={item.date} style={{ display: "flex", gap: 16, paddingBottom: i < 2 ? 24 : 0 }}>
                      <div style={{ display: "flex", flexDirection: "column", alignItems: "center" }}>
                        <div style={{ width: 12, height: 12, borderRadius: "50%", background: item.current ? "#6366F1" : "#C7D2FE", border: `3px solid ${item.current ? "#EEF2FF" : "#F3F4F6"}`, flexShrink: 0, marginTop: 2 }} />
                ...
                <div style={{ background: "#fff", border: "1px solid #E5E7EB", borderRadius: 16, padding: 32 }}>
                  <div style={{ display: "grid", gridTemplateColumns: "repeat(4,1fr)", gap: 24, textAlign: "center" }}>
                    {[
                      { num: "12,400+", label: "생성 콘텐츠", color: "#6366F1" },
                      { num: "98%", label: "고객 만족도", color: "#8B5CF6" },
                ...
                <div style={{ background: "#fff", border: "1px solid #E5E7EB", borderRadius: 16, padding: 32, display: "flex", alignItems: "center", gap: 48, flexWrap: "wrap" }}>
                  ...
                  <div style={{ position: "relative", flexShrink: 0 }}>
                    <svg width={160} height={160} viewBox="0 0 160 160">
                      ...
                      {/* 카드뉴스 38% */}
                      <circle cx={80} cy={80} r={60} fill="none" stroke="#6366F1" strokeWidth={24}
                        strokeDasharray={`${2 * Math.PI * 60 * 0.38} ${2 * Math.PI * 60 * 0.62}`}
                        strokeDashoffset={2 * Math.PI * 60 * 0.25}
                        strokeLinecap="round" />
                      {/* 블로그 25% */}
                      <circle cx={80} cy={80} r={60} fill="none" stroke="#8B5CF6" strokeWidth={24}
                  ...
                  <div style={{ display: "flex", flexDirection: "column", gap: 14 }}>
                    {[
                      { label: "카드뉴스", pct: 38, color: "#6366F1" },
                      { label: "블로그", pct: 25, color: "#8B5CF6" },
          ...
          {active === "Media Cards" && (
            <div>
              <div className="ds-section">
                ...
                <div style={{ display: "grid", gridTemplateColumns: "repeat(3,1fr)", gap: 16, marginBottom: 32 }}>
                  {[
                    { tag: "업데이트", date: "2026.04.08", title: "FlowPack v2, AI 영상 캡션 생성 지원", desc: "이제 유튜브 영상 링크만 넣으면 자동으로 SNS 캡션이 생성됩니다.", color: "#6366F1" },
                ...
                <div style={{ background: "#fff", border: "2px dashed #E5E7EB", borderRadius: 16, padding: "60px 40px", textAlign: "center", marginBottom: 24 }}>
                  ...
                  <button style={{ padding: "12px 24px", borderRadius: 10, background: "#6366F1", color: "#fff", border: "none", fontSize: 14, fontWeight: 600, cursor: "pointer", display: "inline-flex", alignItems: "center", gap: 8 }}>
