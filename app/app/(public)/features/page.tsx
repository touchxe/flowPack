...
const features = [
  {
    ...
    tag: "5분 제작", iconColor: "var(--fp-primary-subtle0)", iconBg: "#EEF2FF",
  ...
  },
  {
    ...
    tag: "원클릭 배포", iconColor: "var(--fp-primary-subtle0)", iconBg: "#F5F3FF",
  ...
  },
  {
    ...
    tag: "95% 일치도", iconColor: "var(--fp-primary-subtle0)", iconBg: "#EEF2FF",
  ...
  },
  {
    ...
    tag: "저작권 FREE", iconColor: "var(--fp-primary-subtle0)", iconBg: "#F5F3FF",
  ...
  },
  {
    ...
    tag: "일주일치 한번에", iconColor: "var(--fp-primary-subtle0)", iconBg: "#EEF2FF",
    ...
    <div style={{ minHeight: "100vh", background: "var(--fp-page-bg)" }}>
      <style>{`
        ...
        * { font-family: 'Pretendard Variable', 'Pretendard', -apple-system, BlinkMacSystemFont, system-ui, sans-serif; }
        ...
        .fp-btn-outline:hover { border-color:var(--fp-primary-subtle0); color:var(--fp-primary-subtle0); background:var(--fp-primary-subtle); }
      ...
      <section style={{ padding: "80px 24px", background: "#F7F8FA" }}>
        <div className="mx-auto max-w-6xl">
          <div style={{ textAlign: "center", marginBottom: 64 }}>
            <div style={{ fontSize: 11, fontWeight: 700, color: "var(--fp-primary-subtle0)", letterSpacing: "0.12em", textTransform: "uppercase", marginBottom: 12 }}>FEATURES</div>
      ...
      <section style={{ padding: "80px 24px", background: "#fff" }}>
        <div className="mx-auto max-w-3xl">
          <div style={{ textAlign: "center", marginBottom: 48 }}>
            <div style={{ fontSize: 11, fontWeight: 700, color: "var(--fp-primary-subtle0)", letterSpacing: "0.12em", textTransform: "uppercase", marginBottom: 12 }}>COMPARISON</div>
          ...
          <div style={{ background: "var(--fp-card-bg)", borderRadius: 20, border: "1px solid var(--fp-border)", overflow: "hidden", boxShadow: "var(--fp-shadow-card)" }}>
            <div className="comp-row" style={{ background: "#F9FAFB", borderBottom: "1px solid #E5E7EB" }}>
              ...
              <span style={{ fontSize: 11, fontWeight: 700, color: "var(--fp-primary-subtle0)", textTransform: "uppercase", letterSpacing: "0.08em", textAlign: "center" }}>FlowPack</span>
            </div>
            {comparisons.map((c, i) => (
              <div key={i} className="comp-row">
                ...
                <span style={{ fontSize: 13, fontWeight: 700, color: "var(--fp-primary-subtle0)", textAlign: "center", display: "flex", alignItems: "center", justifyContent: "center", gap: 4 }}>
      ...
      <section style={{ padding: "80px 24px", background: "#F7F8FA" }}>
        <div className="mx-auto max-w-3xl">
          <div style={{ textAlign: "center", marginBottom: 48 }}>
            <div style={{ fontSize: 11, fontWeight: 700, color: "var(--fp-primary-subtle0)", letterSpacing: "0.12em", textTransform: "uppercase", marginBottom: 12 }}>TOOL CONSOLIDATION</div>
          ...
          <div style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: 16, marginBottom: 48, flexWrap: "wrap" }}>
            {[
              ...
              { name: "Canva", desc: "카드뉴스 디자인", color: "var(--fp-primary-subtle0)", bg: "#F5F3FF" },
            ...
            <div style={{ fontSize: 20, color: "var(--fp-primary-subtle0)", fontWeight: 700, margin: "0 8px" }}>→</div>
            <div style={{ textAlign: "center", padding: "16px 28px", borderRadius: 14, background: "var(--fp-primary-subtle)", border: "2px solid var(--fp-primary-subtle0)", minWidth: 120, boxShadow: "var(--fp-shadow-glow)" }}>
              <div style={{ fontSize: 22, marginBottom: 6 }}>⚡</div>
              <div style={{ fontSize: 14, fontWeight: 800, color: "var(--fp-primary-subtle0)" }}>FlowPack</div>
              <div style={{ fontSize: 11, color: "var(--fp-primary-subtle0)", marginTop: 2, fontWeight: 600 }}>ALL IN ONE</div>
            </div>
          </div>
      ...
      <section style={{ padding: "80px 24px", background: "#F7F8FA" }}>
        <div className="mx-auto max-w-6xl">
          <div style={{ textAlign: "center", marginBottom: 64 }}>
            <div style={{ fontSize: 11, fontWeight: 700, color: "var(--fp-primary-subtle0)", letterSpacing: "0.12em", textTransform: "uppercase", marginBottom: 12 }}>HOW IT WORKS</div>
            <h2 style={{ fontSize: "clamp(24px,4vw,36px)", fontWeight: 700, color: "var(--heading)" }}>3단계로 끝납니다</h2>
          </div>
          <div style={{ display: "grid", gridTemplateColumns: "repeat(3,1fr)", gap: 32, position: "relative" }}>
            {[
              { n: "01", title: "주제 입력", desc: "만들고 싶은 콘텐츠의 주제와 톤을 선택합니다. 키워드 하나면 충분해요.", color: "var(--fp-primary-subtle0)", shadow: "rgba(99,102,241,0.3)" },
              { n: "02", title: "AI 생성", desc: "AI가 콘텐츠를 자동 생성합니다. 마음에 들지 않으면 재생성.", color: "var(--fp-primary-subtle0)", shadow: "rgba(139,92,246,0.3)" },
        ...
        <div className="mx-auto max-w-4xl">
          <div style={{ borderRadius: 24, padding: "clamp(40px,5vw,72px)", textAlign: "center", background: "var(--brand-gradient)", position: "relative", overflow: "hidden", boxShadow: "var(--fp-shadow-hover)" }}>
            ...
            <div style={{ position: "relative" }}>
              ...
              <Link href="/register" style={{ display: "inline-flex", alignItems: "center", gap: 8, height: 52, padding: "0 36px", borderRadius: 12, background: "#fff", color: "var(--fp-primary-subtle0)", fontSize: 16, fontWeight: 700, textDecoration: "none", boxShadow: "0 4px 14px rgba(0,0,0,0.1)" }}>
