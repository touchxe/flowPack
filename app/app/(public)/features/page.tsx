...
const features = [
  {
    ...
    tag: "5분 제작", iconColor: "#6366F1", iconBg: "#EEF2FF",
  ...
  },
  {
    ...
    tag: "원클릭 배포", iconColor: "#8B5CF6", iconBg: "#F5F3FF",
  ...
  },
  {
    ...
    tag: "95% 일치도", iconColor: "#6366F1", iconBg: "#EEF2FF",
  ...
  },
  {
    ...
    tag: "저작권 FREE", iconColor: "#8B5CF6", iconBg: "#F5F3FF",
  ...
  },
  {
    ...
    tag: "일주일치 한번에", iconColor: "#6366F1", iconBg: "#EEF2FF",
    ...
    <div style={{ minHeight: "100vh", background: "#fff" }}>
      <style>{`
        ...
        * { font-family: 'Pretendard Variable', 'Pretendard', -apple-system, BlinkMacSystemFont, system-ui, sans-serif; }
        ...
        .fp-grad-text { background: linear-gradient(135deg,#6366F1,#8B5CF6); -webkit-background-clip:text; -webkit-text-fill-color:transparent; background-clip:text; }
        .fp-btn-primary { background:linear-gradient(135deg,#6366F1,#8B5CF6); color:#fff; border-radius:10px; font-weight:600; transition:all 0.25s; box-shadow:0 4px 14px rgba(99,102,241,0.35); }
        ...
        .fp-btn-outline:hover { border-color:#6366F1; color:#6366F1; background:#EEF2FF; }
      ...
      <section style={{ padding: "80px 24px 96px", background: "#fff", position: "relative", overflow: "hidden", textAlign: "center" }}>
        ...
        <div className="mx-auto max-w-4xl" style={{ position: "relative" }}>
          <div style={{ display: "inline-flex", alignItems: "center", gap: 8, padding: "6px 16px", borderRadius: 9999, background: "#EEF2FF", border: "1px solid #C7D2FE", fontSize: 13, fontWeight: 600, color: "#6366F1", marginBottom: 24 }}>
      ...
      <section style={{ padding: "80px 24px", background: "#F7F8FA" }}>
        <div className="mx-auto max-w-6xl">
          <div style={{ textAlign: "center", marginBottom: 64 }}>
            <div style={{ fontSize: 11, fontWeight: 700, color: "#6366F1", letterSpacing: "0.12em", textTransform: "uppercase", marginBottom: 12 }}>FEATURES</div>
      ...
      <section style={{ padding: "80px 24px", background: "#fff" }}>
        <div className="mx-auto max-w-3xl">
          <div style={{ textAlign: "center", marginBottom: 48 }}>
            <div style={{ fontSize: 11, fontWeight: 700, color: "#6366F1", letterSpacing: "0.12em", textTransform: "uppercase", marginBottom: 12 }}>COMPARISON</div>
          ...
          <div style={{ background: "#fff", borderRadius: 20, border: "1px solid #E5E7EB", overflow: "hidden", boxShadow: "0 4px 20px rgba(0,0,0,0.04)" }}>
            <div className="comp-row" style={{ background: "#F9FAFB", borderBottom: "1px solid #E5E7EB" }}>
              ...
              <span style={{ fontSize: 11, fontWeight: 700, color: "#6366F1", textTransform: "uppercase", letterSpacing: "0.08em", textAlign: "center" }}>FlowPack</span>
            </div>
            {comparisons.map((c, i) => (
              <div key={i} className="comp-row">
                ...
                <span style={{ fontSize: 13, fontWeight: 700, color: "#6366F1", textAlign: "center", display: "flex", alignItems: "center", justifyContent: "center", gap: 4 }}>
      ...
      <section style={{ padding: "80px 24px", background: "#F7F8FA" }}>
        <div className="mx-auto max-w-3xl">
          <div style={{ textAlign: "center", marginBottom: 48 }}>
            <div style={{ fontSize: 11, fontWeight: 700, color: "#6366F1", letterSpacing: "0.12em", textTransform: "uppercase", marginBottom: 12 }}>TOOL CONSOLIDATION</div>
          ...
          <div style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: 16, marginBottom: 48, flexWrap: "wrap" }}>
            {[
              ...
              { name: "Canva", desc: "카드뉴스 디자인", color: "#8B5CF6", bg: "#F5F3FF" },
            ...
            <div style={{ fontSize: 20, color: "#6366F1", fontWeight: 700, margin: "0 8px" }}>→</div>
            <div style={{ textAlign: "center", padding: "16px 28px", borderRadius: 14, background: "linear-gradient(135deg, #EEF2FF, #F5F3FF)", border: "2px solid #6366F1", minWidth: 120, boxShadow: "0 4px 20px rgba(99,102,241,0.18)" }}>
              <div style={{ fontSize: 22, marginBottom: 6 }}>⚡</div>
              <div style={{ fontSize: 14, fontWeight: 800, color: "#6366F1" }}>FlowPack</div>
              <div style={{ fontSize: 11, color: "#8B5CF6", marginTop: 2, fontWeight: 600 }}>ALL IN ONE</div>
            </div>
          </div>
      ...
      <section style={{ padding: "80px 24px", background: "#F7F8FA" }}>
        <div className="mx-auto max-w-6xl">
          <div style={{ textAlign: "center", marginBottom: 64 }}>
            <div style={{ fontSize: 11, fontWeight: 700, color: "#6366F1", letterSpacing: "0.12em", textTransform: "uppercase", marginBottom: 12 }}>HOW IT WORKS</div>
            <h2 style={{ fontSize: "clamp(24px,4vw,36px)", fontWeight: 700, color: "var(--heading)" }}>3단계로 끝납니다</h2>
          </div>
          <div style={{ display: "grid", gridTemplateColumns: "repeat(3,1fr)", gap: 32, position: "relative" }}>
            {[
              { n: "01", title: "주제 입력", desc: "만들고 싶은 콘텐츠의 주제와 톤을 선택합니다. 키워드 하나면 충분해요.", color: "#6366F1", shadow: "rgba(99,102,241,0.3)" },
              { n: "02", title: "AI 생성", desc: "AI가 콘텐츠를 자동 생성합니다. 마음에 들지 않으면 재생성.", color: "#8B5CF6", shadow: "rgba(139,92,246,0.3)" },
      ...
      <section style={{ padding: "80px 24px" }}>
        <div className="mx-auto max-w-4xl">
          <div style={{ borderRadius: 24, padding: "clamp(40px,5vw,72px)", textAlign: "center", background: "linear-gradient(135deg,#6366F1,#8B5CF6)", position: "relative", overflow: "hidden", boxShadow: "0 20px 60px rgba(99,102,241,0.30)" }}>
            ...
            <div style={{ position: "relative" }}>
              ...
              <Link href="/register" style={{ display: "inline-flex", alignItems: "center", gap: 8, height: 52, padding: "0 36px", borderRadius: 12, background: "#fff", color: "#6366F1", fontSize: 16, fontWeight: 700, textDecoration: "none", boxShadow: "0 4px 14px rgba(0,0,0,0.1)" }}>
