    ...
    <main style={{ minHeight: "100vh", display: "flex", alignItems: "center", justifyContent: "center", background: "linear-gradient(135deg,#F8F7FF 0%,#EEF2FF 100%)", padding: "24px" }}>
      <style>{`
        ...
        * { font-family:'Pretendard Variable','Pretendard',-apple-system,BlinkMacSystemFont,system-ui,sans-serif; }
        ...
        .lf-input:focus { border-color:#6366F1; box-shadow:0 0 0 3px rgba(99,102,241,0.12); }
        ...
        .lf-social:hover { border-color:#C7D2FE; background:#F8F7FF; color:#6366F1; }
        .lf-social:disabled { opacity:0.5; cursor:not-allowed; }
        .lf-submit { width:100%; height:46px; border-radius:10px; font-size:15px; font-weight:700; cursor:pointer; border:none; background:linear-gradient(135deg,#6366F1,#8B5CF6); color:#fff; display:flex; align-items:center; justify-content:center; gap:8px; transition:all 0.25s; box-shadow:0 4px 14px rgba(99,102,241,0.35); }
      ...
      <div style={{ width: "100%", maxWidth: 420 }}>
        ...
        <div style={{ background: "#fff", borderRadius: 20, padding: "36px 32px", boxShadow: "0 4px 40px rgba(99,102,241,0.10)", border: "1px solid #E5E7EB" }}>
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div style={{ marginBottom: 20 }}>
              <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 6 }}>
                ...
                <Link href="/find-password" style={{ fontSize: 12, color: "#6366F1", textDecoration: "none", fontWeight: 500 }}>비밀번호를 잊으셨나요?</Link>
              </div>
          ...
          <p style={{ textAlign: "center", fontSize: 13, color: "#9CA3AF", marginTop: 20 }}>
            계정이 없으신가요?{" "}
            <Link href="/register" style={{ color: "#6366F1", fontWeight: 700, textDecoration: "none" }}>회원가입</Link>
          </p>
        </div>
