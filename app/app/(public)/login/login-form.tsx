    ...
    <main style={{ minHeight: "100vh", display: "flex", alignItems: "center", justifyContent: "center", background: "linear-gradient(135deg,#F8F7FF 0%,#EEF2FF 100%)", padding: "24px" }}>
      <style>{`
        ...
        * { font-family:'Pretendard Variable','Pretendard',-apple-system,BlinkMacSystemFont,system-ui,sans-serif; }
        ...
        .lf-submit:hover:not(:disabled) { transform:translateY(-1px); box-shadow:0 8px 24px var(--fp-primary-subtle); }
      ...
      <div style={{ width: "100%", maxWidth: 420 }}>
        ...
        <div style={{ background: "#fff", borderRadius: 20, padding: "36px 32px", boxShadow: "0 4px 40px var(--fp-primary-subtle)", border: "1px solid #E5E7EB" }}>
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div style={{ marginBottom: 20 }}>
              <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 6 }}>
                ...
                <Link href="/find-password" style={{ fontSize: 12, color: "var(--brand-500)", textDecoration: "none", fontWeight: 500 }}>비밀번호를 잊으셨나요?</Link>
              </div>
          ...
          <p style={{ textAlign: "center", fontSize: 13, color: "#9CA3AF", marginTop: 20 }}>
            계정이 없으신가요?{" "}
            <Link href="/register" style={{ color: "var(--brand-500)", fontWeight: 700, textDecoration: "none" }}>회원가입</Link>
          </p>
        </div>
