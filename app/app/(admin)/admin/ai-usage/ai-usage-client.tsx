...
const FEATURE_COLORS: Record<string, string> = {
  CAROUSEL: "var(--fp-primary-subtle0)", BLOG: "#10b981", BULK: "#ef4444",
  URL_TO_POST: "var(--fp-primary-subtle0)", LONGFORM: "#F59E0B",
};
...
const MODEL_COLORS: Record<string, string> = {
  ...
  "gpt-4o": "var(--fp-primary-subtle0)", "gpt-4o-mini": "var(--fp-primary-subtle0)",
  ...
  // xAI
  "grok-4": "#a855f7", "grok-4-mini": "var(--fp-primary-subtle0)", "grok-3": "#7c3aed", "grok-3-mini": "#ddd6fe",
  // MiniMax
