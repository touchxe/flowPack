...
const features = [
  { icon: <Layers className="h-7 w-7" />, title: "카드뉴스", desc: "레퍼런스 디자인을 학습해 브랜드 톤에 맞는 카드뉴스를 5분 만에 자동 생성합니다. 반복 작업 없이 무한 제작하세요.", tag: "5분 제작", iconBg: "#EEF2FF", iconColor: "var(--fp-primary-subtle0)" },
  ...
  { icon: <Share2 className="h-7 w-7" />, title: "멀티채널 배포", desc: "Instagram, Facebook, Twitter 등 6개 채널에 단 한 번의 클릭으로 동시 발행합니다. 예약 배포도 지원합니다.", tag: "한 번의 클릭", iconBg: "#F5F3FF", iconColor: "var(--fp-primary-subtle0)" },
];
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
                {[
                  ...
                  <div key={i} style={{ background: "#fff", borderRadius: 10, padding: "10px 16px", display: "flex", alignItems: "center", gap: 12 }}>
                    <span style={{ fontSize: 11, fontWeight: 800, color: "var(--fp-primary-subtle0)", minWidth: 20 }}>{s.step}</span>
    ...
    <section style={{ padding: "80px 0", background: "linear-gradient(180deg, #F8F7FF 0%, #EEF2FF 100%)" }}>
      <div className="mx-auto max-w-5xl px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6" style={{ marginBottom: 40 }}>
          ...
          <div style={{ background: "#fff", border: "2px solid var(--fp-primary-subtle0)", borderRadius: 20, padding: 32, position: "relative", overflow: "hidden", boxShadow: "0 8px 24px rgba(99,102,241,0.15)" }}>
            <div style={{ position: "absolute", top: 0, right: 0, background: "var(--fp-primary-subtle0)", color: "#fff", fontSize: 11, fontWeight: 700, padding: "4px 12px", borderBottomLeftRadius: 10 }}>추천</div>
            ...
            {[
              ...
              <div key={item.label} style={{ display: "flex", justifyContent: "space-between", padding: "8px 0", borderBottom: "1px solid #F3F4F6" }}>
                <span style={{ fontSize: 14, color: "var(--fp-secondary)" }}>{item.label}</span>
                <span style={{ fontSize: 14, fontWeight: 600, color: "var(--fp-primary-subtle0)" }}>{item.value}</span>
              </div>
            ))}
          </div>
        </div>
        <div style={{ background: "#fff", borderRadius: 20, border: "1.5px solid var(--fp-border)", padding: 32 }}>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 16, marginBottom: 20, flexWrap: "wrap", justifyContent: "center" }}>
            ...
            <input type="range" min={10} max={100} step={5} value={contentCount} onChange={e => setContentCount(Number(e.target.value))}
              style={{ width: 200, accentColor: "var(--fp-primary-subtle0)" }} />
            <span style={{ fontSize: 20, fontWeight: 800, color: "var(--fp-primary-subtle0)", minWidth: 60 }}>{contentCount}건</span>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4" style={{ textAlign: "center" }}>
            ...
            <div style={{ background: "var(--brand-light)", borderRadius: 12, padding: 16 }}>
              ...
              <p style={{ fontSize: 24, fontWeight: 800, color: "var(--fp-primary-subtle0)" }}>₩{fpMonthlyCost.toLocaleString()}</p>
            </div>
    ...
    <div className="min-h-screen bg-white">
      <style>{`
        ...
        * { font-family: 'Pretendard Variable', 'Pretendard', -apple-system, BlinkMacSystemFont, system-ui, sans-serif; }
        ...
        :root {
          --fp-primary-subtle0: var(--fp-primary-subtle0);
          --brand-primary-hover: var(--brand-600);
          --uv: var(--fp-primary-subtle0);
          --brand-light: #EEF2FF;
          --brand-subtle: #F8F7FF;
          --brand-border: #C7D2FE;
          --fp-heading: #111827;
        ...
        .fp-gradient-text {
          background: linear-gradient(135deg, var(--fp-primary-subtle0), var(--uv));
        ...
        .fp-btn-secondary:hover {
          border-color: var(--fp-primary-subtle0);
        ...
        .fp-cta-banner {
          background: linear-gradient(135deg, var(--fp-primary-subtle0) 0%, var(--fp-primary-subtle0) 100%);
              ...
              <div style={{ display: "grid", gridTemplateColumns: "220px 1fr", minHeight: 280 }}>
                ...
                <div style={{ borderRight: "1px solid var(--fp-border-soft)", padding: 16, background: "var(--fp-surface)" }}>
                  ...
                  {[
                    ...
                    <div key={item.label} style={{ display: "flex", alignItems: "center", gap: 8, padding: "8px 10px", borderRadius: 8, marginBottom: 2, background: item.active ? "linear-gradient(135deg,var(--fp-primary-subtle0),var(--fp-primary-subtle0))" : "transparent", color: item.active ? "#fff" : "var(--fp-secondary)", fontSize: 12, fontWeight: item.active ? 600 : 400, cursor: "pointer" }}>
                ...
                <div style={{ padding: 20 }}>
                  ...
                  <div style={{ display: "grid", gridTemplateColumns: "repeat(3,1fr)", gap: 12, marginBottom: 20 }}>
                    {[
                      { label: "이번 달 생성", value: "24", icon: <Sparkles size={14} color="var(--fp-primary-subtle0)" />, bg: "#EEF2FF" },
            ...
            {features.map((f, i) => (
              ...
              >
                ...
                <Link href="/features" style={{
                  ...
                  textTransform: "uppercase", color: "var(--fp-primary-subtle0)",
                  textDecoration: "none",
                }}>
                  — LEARN MORE
                </Link>
      ...
      <section style={{ padding: "96px 0", background: "#fff" }}>
        <div className="mx-auto max-w-6xl px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8" style={{ position: "relative" }}>
            {[
              { n: "01", title: "주제 입력", desc: "만들고 싶은 콘텐츠의 주제와 톤을 선택합니다.", color: "var(--fp-primary-subtle0)", shadow: "rgba(99,102,241,0.3)" },
              { n: "02", title: "AI 생성", desc: "AI가 콘텐츠를 생성합니다. 마음에 들지 않으면 재생성.", color: "var(--fp-primary-subtle0)", shadow: "rgba(139,92,246,0.3)" },
            ...
            {testimonials.map((t) => (
              <div key={t.handle} className="fp-testimonial" style={{ padding: 24 }}>
                <div className="flex items-center gap-3" style={{ marginBottom: 16 }}>
                  <div style={{ width: 44, height: 44, borderRadius: "50%", background: "linear-gradient(135deg,var(--fp-primary-subtle0),var(--fp-primary-subtle0))", display: "flex", alignItems: "center", justifyContent: "center", fontSize: 14, fontWeight: 700, color: "#fff" }}>
                    {t.avatar}
                  </div>
                  <div>
