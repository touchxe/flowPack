    ...
    <div style={{ height: "100%", display: "flex", flexDirection: "column", background: "#F7F8FA" }}>
      <style>{`
        ...
        * { font-family:'Pretendard Variable','Pretendard',-apple-system,sans-serif; }
        ...
        .cl-input:focus { border-color:var(--fp-primary-subtle0); box-shadow:0 0 0 3px rgba(99,102,241,0.10); }
        ...
        .seg-btn.active { border-color:var(--fp-primary-subtle0); background:#EEF2FF; color:var(--fp-primary-subtle0); }
        .seg-btn:hover:not(.active) { border-color:#C7D2FE; }
        .gen-btn { width:100%; height:48px; border-radius:12px; font-size:15px; font-weight:700; cursor:pointer; border:none; background:linear-gradient(135deg,var(--fp-primary-subtle0),var(--fp-primary-subtle0)); color:#fff; display:flex; align-items:center; justify-content:center; gap:8px; transition:all 0.25s; box-shadow:0 4px 14px rgba(99,102,241,0.35); }
      ...
      <div style={{ display: "grid", gridTemplateColumns: "360px 1fr", flex: 1, minHeight: 0 }}>
        ...
        <div style={{ background: "#fff", borderRight: "1px solid #F3F4F6", display: "flex", flexDirection: "column", overflowY: "auto" }}>
          ...
          <div style={{ padding: "20px 20px 16px", borderBottom: "1px solid #F3F4F6", display: "flex", alignItems: "center", gap: 10 }}>
            <div style={{ width: 36, height: 36, borderRadius: 10, background: "linear-gradient(135deg,var(--fp-primary-subtle0),var(--fp-primary-subtle0))", display: "flex", alignItems: "center", justifyContent: "center" }}>
          ...
          <div style={{ margin: "14px 16px 0", padding: "12px 14px", borderRadius: 12, background: pc < 30 ? "#FFF7ED" : "#EEF2FF", border: `1px solid ${pc < 30 ? "#FED7AA" : "#C7D2FE"}` }}>
            <div style={{ display: "flex", justifyContent: "space-between", marginBottom: 6 }}>
              <span style={{ fontSize: 11, fontWeight: 700, color: pc < 30 ? "#D97706" : "var(--fp-primary-subtle0)", textTransform: "uppercase", letterSpacing: "0.06em" }}>크레딧</span>
              <span style={{ fontSize: 12, fontWeight: 800, color: pc < 30 ? "#D97706" : "var(--fp-primary-subtle0)" }}>{userCredits.availableCredits} / {userCredits.creditsTotal}</span>
            </div>
            <div style={{ height: 5, background: "#E5E7EB", borderRadius: 3, overflow: "hidden" }}>
              <div style={{ height: "100%", width: `${pc}%`, background: pc < 30 ? "linear-gradient(90deg,#F59E0B,#D97706)" : "linear-gradient(90deg,var(--fp-primary-subtle0),var(--fp-primary-subtle0))", transition: "width 0.4s", borderRadius: 3 }} />
            </div>
          </div>
          ...
          <div style={{ flex: 1, padding: "16px", display: "flex", flexDirection: "column", gap: 16, overflowY: "auto" }}>
            ...
            {/* 슬라이드 수 */}
            <div>
              <label style={{ fontSize: 12, fontWeight: 700, color: "#374151", display: "block", marginBottom: 8, textTransform: "uppercase", letterSpacing: "0.05em" }}>슬라이드 수: <span style={{ color: "var(--fp-primary-subtle0)" }}>{slideCount}장</span></label>
              <div style={{ position: "relative" }}>
                <input type="range" min={3} max={10} value={slideCount} onChange={e => setSlideCount(parseInt(e.target.value))} disabled={isGenerating} style={{ width: "100%", accentColor: "var(--fp-primary-subtle0)" }} />
          ...
          <div style={{ padding: "16px 24px", background: "#fff", borderBottom: "1px solid #F3F4F6", display: "flex", alignItems: "center", justifyContent: "space-between", position: "sticky", top: 0, zIndex: 10 }}>
            <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
              ...
              {generatedSlides.length > 0 && (
                <span style={{ fontSize: 12, padding: "3px 10px", borderRadius: 9999, background: "#EEF2FF", color: "var(--fp-primary-subtle0)", fontWeight: 600 }}>
            ...
            {generatedSlides.length > 0 && (
              <div style={{ display: "flex", gap: 8 }}>
                ...
                <button className="action-btn" onClick={() => setPublishModalOpen(true)} disabled={!contentId}
                  style={{ border: "none", background: "linear-gradient(135deg,var(--fp-primary-subtle0),var(--fp-primary-subtle0))", color: "#fff", boxShadow: "0 2px 8px rgba(99,102,241,0.3)" }}>
                  <Send size={13} /> 배포
                </button>
              </div>
            )}
            ...
            {generatedSlides.length > 0 ? (
                    ...
                    <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 10 }}>
                      ...
                      {slide.imageUrl ? (
                        ...
                        <button onClick={() => openImageModal(i)}
                          style={{ display: "flex", alignItems: "center", gap: 5, padding: "5px 10px", borderRadius: 8, background: "#EEF2FF", border: "1px solid #C7D2FE", color: "var(--fp-primary-subtle0)", fontSize: 12, fontWeight: 600, cursor: "pointer" }}>
              ...
              <div style={{ display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", height: "100%", textAlign: "center" }}>
                <div style={{ width: 72, height: 72, borderRadius: 20, background: "#EEF2FF", display: "flex", alignItems: "center", justifyContent: "center", marginBottom: 16, boxShadow: "0 4px 12px rgba(99,102,241,0.15)" }}>
                  <Layers size={32} color="var(--fp-primary-subtle0)" />
                </div>
        ...
        <div style={{ position: "fixed", inset: 0, zIndex: 50, display: "flex", alignItems: "center", justifyContent: "center", background: "rgba(0,0,0,0.4)", backdropFilter: "blur(4px)" }}>
          <div style={{ background: "#fff", borderRadius: 20, padding: "32px", maxWidth: 400, width: "90%", textAlign: "center", boxShadow: "0 20px 60px rgba(0,0,0,0.15)" }}>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
              <button style={{ height: 46, borderRadius: 10, fontWeight: 700, fontSize: 14, border: "none", background: "linear-gradient(135deg,var(--fp-primary-subtle0),var(--fp-primary-subtle0))", color: "#fff", cursor: "pointer" }}>크레딧 구매</button>
