    ...
    <div style={{ padding: "32px 40px" }}>
      <style>{`
        ...
        * { font-family:'Pretendard Variable','Pretendard',-apple-system,sans-serif; }
        .platform-card { background:var(--fp-card-bg); border:1.5px solid var(--fp-border); border-radius:18px; padding:24px; transition:all 0.2s; }
        .platform-card:hover { border-color:var(--fp-primary-border); box-shadow:var(--fp-shadow-hover); transform:translateY(-2px); }
        .connect-btn { width:100%; height:46px; border-radius:12px; font-size:14px; font-weight:800; cursor:pointer; display:flex; align-items:center; justify-content:center; gap:8px; transition:all 0.2s; border:none; }
        .disconnect-btn { width:38px; height:38px; border-radius:10px; background:none; border:1.5px solid var(--fp-border); cursor:pointer; display:flex; align-items:center; justify-content:center; color:var(--fp-muted); transition:all 0.15s; }
        .disconnect-btn:hover { border-color:var(--fp-error-border); color:var(--fp-error); background:var(--fp-error-bg); }
        .guide-btn { height:38px; padding:0 14px; border-radius:10px; background:none; border:1.5px solid var(--fp-border); cursor:pointer; display:flex; align-items:center; gap:6px; color:var(--fp-secondary); font-size:13px; font-weight:700; transition:all 0.15s; }
        .guide-btn:hover { border-color:var(--fp-primary-border); color:var(--brand-500); background:var(--fp-primary-subtle); }
        .wp-site-item { display:flex; align-items:center; justify-content:space-between; padding:12px 16px; border-radius:12px; background:var(--fp-section-bg, #F9FAFB); border:1px solid var(--fp-border); transition:all 0.15s; }
        .wp-site-item:hover { border-color:var(--fp-primary-border); }
        .wp-add-btn { width:100%; height:44px; border-radius:12px; font-size:14px; font-weight:800; cursor:pointer; display:flex; align-items:center; justify-content:center; gap:7px; transition:all 0.2s; border:1.5px dashed var(--fp-border); background:none; color:var(--fp-secondary); }
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(3, minmax(0,1fr))", gap: 18, marginBottom: 32 }}>
        {[
          ...
          <div key={i} style={{ background: "var(--fp-card-bg)", border: "1.5px solid var(--fp-border)", borderRadius: 16, padding: "20px 24px", display: "flex", alignItems: "center", gap: 16, boxShadow: "var(--fp-shadow-card)" }}>
            ...
            <div>
              <p style={{ fontSize: 30, fontWeight: 800, color: k.color, margin: 0 }}>{k.value}</p>
              <p style={{ fontSize: 13, color: "var(--fp-muted)", margin: 0, fontWeight: 700 }}>{k.label}</p>
            </div>
          </div>
        ))}
      </div>
      ...
      {accounts.length > 0 && (
        <div style={{ marginBottom: 28 }}>
          <h2 style={{ fontSize: 18, fontWeight: 800, color: "var(--fp-heading)", marginBottom: 16, display: "flex", alignItems: "center", gap: 8 }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
            {loading ? (
              ...
              if (!cfg) return null;
              return (
                <div key={account.id} style={{ background: "var(--fp-card-bg)", border: "1.5px solid var(--fp-border)", borderRadius: 16, padding: "20px 24px", display: "flex", alignItems: "center", justifyContent: "space-between", boxShadow: "var(--fp-shadow-card)" }}>
