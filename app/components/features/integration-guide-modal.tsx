...
export const INTEGRATION_GUIDES: Record<string, {
  ...
  NAVER_BLOG: {
    ...
    steps: [
      {
        title: "1. 콘텐츠 생성",
        desc: "FlowPack에서 블로그 글을 작성합니다. 제목, 본문, 이미지가 자동으로 네이버 블로그 최적화 형식으로 만들어집니다.",
      },
      {
        title: "2. 복사 버튼 클릭",
        desc: "완성된 콘텐츠 하단의 [네이버 블로그용 복사] 버튼을 클릭합니다. HTML 구조가 네이버 에디터에 호환되는 형태로 클립보드에 복사됩니다.",
        code: "지원 형식: 제목 / 본문 텍스트 / 이미지 삽입 위치 표시 / 해시태그",
      },
      {
        title: "3. 네이버 블로그 에디터 열기",
        desc: "네이버 블로그(blog.naver.com)에 접속하여 [글쓰기]를 클릭합니다. 스마트에디터 ONE이 열립니다.",
        link: { label: "네이버 블로그 열기", url: "https://blog.naver.com" },
      },
      {
        title: "4. 붙여넣기(Ctrl+V)",
        desc: "에디터 본문 영역을 클릭한 후 Ctrl+V(Mac: Cmd+V)로 붙여넣습니다. 이미지는 별도로 삽입해야 합니다.",
        code: "단축키: Ctrl+V (Windows) / Cmd+V (Mac)",
      },
      {
        title: "5. 이미지 삽입 및 발행",
        desc: "이미지 삽입 위치(<!-- IMAGE -->) 부분에 FlowPack에서 다운로드한 이미지를 드래그앤드롭으로 삽입한 뒤 [발행]을 클릭합니다.",
      },
    ],
    tips: [
      "네이버는 공식 블로그 API를 제공하지 않아 자동 발행이 불가합니다.",
      "이미지는 FlowPack에서 다운로드 후 네이버 에디터에 직접 삽입해야 합니다.",
      "네이버 검색 최적화를 위해 제목에 주요 키워드를 포함하고 해시태그를 5~10개 추가하세요.",
      "스마트에디터 ONE 기준으로 최적화되어 있습니다. 구버전 에디터에선 서식이 다를 수 있습니다.",
      "카카오채널, 네이버 카페도 동일한 방식으로 붙여넣기 가능합니다.",
    ],
  },
  INSTAGRAM: {
