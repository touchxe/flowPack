  ...
  return (
    <div style={{
      ...
      <button type="button" onClick={() => onConfirm(url)}
        style={{ height: 32, padding: "0 12px", borderRadius: 7, background: "linear-gradient(135deg,#6366F1,#8B5CF6)", border: "none", color: "#fff", fontSize: 12, fontWeight: 700, cursor: "pointer" }}>
        확인
      </button>
  ...
  return (
    <div className="tiptap-editor-wrap" style={{ display: "flex", flexDirection: "column", flex: 1 }}>
      <style>{`
        ...
        /* ── 인용/코드 ── */
        .tiptap-prosemirror blockquote { border-left:4px solid #6366F1; background:#F8F7FF; padding:14px 18px; margin:16px 0; border-radius:0 8px 8px 0; color:#4F46E5; font-weight:500; }
        .tiptap-prosemirror code { background:#F3F4F6; padding:2px 7px; border-radius:5px; font-size:13px; font-family:'Fira Code','Menlo',monospace; color:#6366F1; }
        ...
        /* ── 링크/이미지/구분선 ── */
        .tiptap-link { color:#6366F1; text-decoration:underline; text-underline-offset:3px; cursor:pointer; }
