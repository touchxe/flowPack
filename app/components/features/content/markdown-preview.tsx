  ...
  return (
    <div className={className} style={{ padding: "24px 28px", ...style }}>
      <style>{`
        ...
        .md-preview blockquote { border-left: 4px solid var(--fp-primary-subtle0); background: #F8F7FF; padding: 14px 18px; margin: 16px 0; border-radius: 0 8px 8px 0; color: var(--brand-600); font-weight: 500; }
        .md-preview code { background: #F3F4F6; padding: 2px 7px; border-radius: 5px; font-size: 13px; font-family: 'Fira Code','Menlo',monospace; color: var(--fp-primary-subtle0); }
        ...
        .md-preview a { color: var(--fp-primary-subtle0); text-decoration: underline; text-underline-offset: 3px; }
