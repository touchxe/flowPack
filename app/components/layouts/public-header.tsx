    ...
    <header style={{
      ...
      <div style={{ maxWidth: 1152, margin: "0 auto", padding: "0 24px", height: 64, display: "flex", alignItems: "center", justifyContent: "space-between" }}>
        ...
        <Link href="/" style={{ display: "flex", alignItems: "center", gap: 10, textDecoration: "none" }}>
          <div style={{ width: 34, height: 34, borderRadius: 10, background: "linear-gradient(135deg,var(--brand-500),var(--fp-cyan))", display: "flex", alignItems: "center", justifyContent: "center", boxShadow: "0 2px 8px rgba(99,102,241,0.30)" }}>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 12 }} className="hidden md:flex">
          {status === "loading" ? null : session ? (
            ...
            <Link href="/home" style={{
              ...
              background: "linear-gradient(135deg,var(--brand-500),var(--fp-cyan))",
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
            {session ? (
              ...
              <Link href="/home" onClick={() => setOpen(false)}
                style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: 6, textAlign: "center", fontSize: 14, fontWeight: 700, color: "#fff", padding: "11px", background: "linear-gradient(135deg,var(--brand-500),var(--fp-cyan))", borderRadius: 10, textDecoration: "none" }}>
                <LayoutDashboard size={15} />
                내 대시보드
              </Link>
            ) : (
              ...
              <>
                ...
                <Link href="/register" onClick={() => setOpen(false)}
                  style={{ textAlign: "center", fontSize: 14, fontWeight: 700, color: "#fff", padding: "11px", background: "linear-gradient(135deg,var(--brand-500),var(--fp-cyan))", borderRadius: 10, textDecoration: "none" }}>
                  무료로 시작
                </Link>
              </>
            )}
